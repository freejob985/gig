            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if($a == 0) active @endif" data-toggle="tab" href="#slider_tab_{{$key}}"
                                role="tab" aria-controls="home" aria-selected="true">{{get_language_by_slug($key)}}</a>
                        </li>
                        @php $a++; @endphp
                        @endforeach
                    </ul>
        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin.service.category.update')}}" method="post"   enctype="multipart/form-data" >
                ...
                <div class="modal-body">
                    ...
                    <img class="img-responsive" src="{{Request::root()}}/public/files/{{ $data->a2 }}" alt="Chania">
